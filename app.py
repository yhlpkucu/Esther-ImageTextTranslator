...
def save_image():
    ...
    for t in text_list:
        try:
          r = translate_text(t['text'], 'es')     #  set default target language to spanish 
          print(t, r)
          text_list2.append({'text': t['text'], 'conf': r})
        except:
          text_list2.append({'text': t['text']})
    print(text_list2)

#   text_list2 = [{'text': t['text']} for t in text_list]
